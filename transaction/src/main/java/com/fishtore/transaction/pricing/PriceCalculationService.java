...
public class PriceCalculationService {
    ...
    public BigDecimal fetchBasePriceForSeafood(String seafoodType) {
        ...
        BigDecimal basePrice = restTemplate.getForObject(INVENTORY_SERVICE_URL + "/price/" + seafoodType, BigDecimal.class);
        return basePrice;
    }
    ...
    public BigDecimal calculateFinalPrice(List<TransactionItem> items) {
        ...
        for (TransactionItem item : items) {
            BigDecimal basePrice = fetchBasePriceForSeafood(item.getSeafoodType());
